...
mod tests {
    ...
    fn a_message_with_no_text_offers_no_copy() {
        ...
        sticker.content = Content::Sticker(Box::new(crate::data::message::Sticker {
            pack_id: Vec::new(),
            pack_key: None,
            sticker_id: 0,
            emoji: None,
    ...
    fn an_undownloaded_attachment_offers_nothing() {
        ...
        carrying.attachments.push(crate::data::attachment::Attachment {
            id: crate::data::attachment::Id::from_hex("beef"),
